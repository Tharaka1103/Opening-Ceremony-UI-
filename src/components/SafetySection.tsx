...
const SafetySection = ({
  ...
  return <section className="py-10 bg-white/90 rounded-lg shadow-lg my-8 backdrop-blur-sm">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <button onClick={onViewMap} className="bg-blue-700 hover:bg-blue-800 text-white py-3 px-6 rounded-lg font-semibold transition duration-300 shadow-md flex items-center mx-auto">
